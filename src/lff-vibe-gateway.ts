 ...
 * Based on @mcphub/gateway (Apache 2.0 License) with LFF-VIBE customizations.
 * 
 * Copyright 2024 LFF-VIBE Team
 * Licensed under the Apache License, Version 2.0
 * 
 * Original work: @mcphub/gateway contributors
 * Modifications: LFF-VIBE Team for https://mcpice.com integration
 */
...
async function main() {
    ...
    try {
        ...
        debug(`Fatal error in LFF-VIBE Gateway: ${(error as Error).message}`);
